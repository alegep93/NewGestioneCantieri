...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <%-- Lista Serie --%>
    <div class="row d-flex justify-content-center align-items-center">
        <div class="col-4 text-center table-container">
    ...
    <div class="row d-flex justify-content-center align-items-center">
        <div class="col-10 text-center table-container">
            <asp:GridView ID="grdFruttiSerie" ItemType="GestioneCantieri.Data.FruttoSerie" OnRowCommand="grdFruttiSerie_RowCommand" CssClass="table table-dark table-striped scrollable-table" AutoGenerateColumns="false" runat="server">
                <Columns>
