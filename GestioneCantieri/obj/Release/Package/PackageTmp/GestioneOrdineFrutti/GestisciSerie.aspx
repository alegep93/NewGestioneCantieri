...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="row d-flex justify-content-center align-items-center">
        <div class="col-4 text-center table-container">
            <asp:GridView ID="grdSerie" ItemType="Database.Models.Serie" OnRowCommand="grdSerie_RowCommand" CssClass="table table-dark table-striped scrollable-table" AutoGenerateColumns="false" runat="server">
                <Columns>
