    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6 table-container" style="position: relative; top: 10px;">
                <asp:GridView ID="grdGruppi" AutoGenerateColumns="false" ItemType="GestioneCantieri.Data.StampaCantiere" runat="server" CssClass="table table-striped table-responsive scrollable-table" Visible="false">
                    <Columns>
