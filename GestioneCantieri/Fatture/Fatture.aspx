            ...
            <div class="row">
                ...
                <div class="col-md-12 table-container">
                    <asp:GridView ID="grdFatture" OnRowCommand="grdFatture_RowCommand" AutoGenerateColumns="false"
                        ItemType="GestioneCantieri.Data.Fattura" OnRowDataBound="grdFatture_RowDataBound" runat="server" CssClass="table table-striped table-responsive text-center scrollable-table">
                        <Columns>
